...
| **[⚖️ 决策板 (decision-board)](apps/decision-board/)** | `plugin` | Plan 专用：互斥方案点选，选定后按约束继续执行（Ask/Agent 勿用） | CodePapr |
| **[📝 快捷笔记 (scratch-notes)](apps/scratch-notes/)** | `plugin` | 仅本人快捷笔记：按项目分桶，卡片式文本/代码/链接/图片，无 Agent | CodePapr |
